...
export const selectData: Record<dimensionSelectBarType2d | dimensionSelectBarType3d, ViewSelectItem> = {
  text: {
    list: [
  ...
  media: {
    list: [
      { icon: require('@/assets/images/editor_media_video_btn_dark.png'), name: '视频', type: 'video' },
  ...
  element: {
    list: [
      { icon: require('@/assets/images/editor_element_model_btn_dark.png'), name: '模型', type: 'model' },
