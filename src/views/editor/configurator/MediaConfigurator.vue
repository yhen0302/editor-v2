...
import BaseUploadConfigurator from "@/views/editor/baseConfigurator/BaseUploadConfigurator";

export default {
  name: "MediaConfigurator",
  components: {BaseUploadConfigurator, BasePositionConfigurator}
}
</script>
