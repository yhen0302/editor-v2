  ...
  <nav class="editor_nav box-border w-full bg-gray-dark flex justify-between">
    ...
    <section class="nav_content box-border h-full flex items-center justify-between">
      ...
      <div class="nav_content-right flex justify-between" v-once>
        <tip-button :icon="require('@/assets/images/editor_preview_btn_dark.png')" name="1" tip-position="tb">
          <template v-slot:tip>
            <p>预览</p>
            <p>Ctrl+P</p>
          </template>
        ...
        <tip-button :icon="require('@/assets/images/editor_download_btn_dark.png')" name="1" tip-position="middle">
          <template v-slot:tip>
            <p>导出配置</p>
          </template>
        </tip-button>
        <tip-button :icon="require('@/assets/images/editor_import_btn_dark.png')" name="1" tip-position="middle">
          <template v-slot:tip>
            <p>导入配置</p>
          </template>
        </tip-button>
